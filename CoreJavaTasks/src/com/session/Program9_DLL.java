...
public class Program9_DLL {
	...
	public static void main(String[] args) {
		...
		Program9_DLL dll = new Program9_DLL();
		...
		dll.push(3);
		// Insert 4. So linked list becomes 4->3->2->1->NULL
		dll.push(4);
		...
		System.out.print("DLL after deleting first node: ");
		dll.printlist(dll.head);

		dll.deleteNode(dll.head, dll.head.next);

		System.out.print("DLL after Deleting middle node: ");
		dll.printlist(dll.head);

		dll.push(10);
		System.out.print("DLL after adding element : ");
		dll.printlist(dll.head);
	}
}
